...
$sql = "SELECT invoice_id, company_name, company_address, delivery_date, contact_person, total_vat, order_status, created_by 
        FROM invoice WHERE order_status = 3";
...
<body>
    <div class="container">
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<a href='view_adinvoice2.php?invoice_id=" . $row['invoice_id'] . "' class='btn btn-primary'>ดูรายละเอียด</a>";
                        echo "</td>";
                        // echo "<td>";
                        ?>
        ...
        <a href="../adminpanel.php" class="btn btn-back btn-primary">กลับ</a>
        <br>
    </div>
    </div>
