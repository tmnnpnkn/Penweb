...
$stmt = mysqli_prepare($conn, $sql_monthly_sales);
mysqli_stmt_bind_param($stmt, "ss", $_GET['year'], $_GET['month']);
mysqli_stmt_execute($stmt);
$result_monthly_sales = mysqli_stmt_get_result($stmt);
    ...
    <script>
        ...
        var monthlySalesChart = new Chart(ctxMonthlySales, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'ยอดขาย (บาท)',
                    data: <?php echo json_encode(array_column($monthly_sales_data, 'total_sales')); ?>,
